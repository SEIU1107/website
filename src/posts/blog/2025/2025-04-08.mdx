...
<Carousel images={[img5, img9, img2, img7, img8]} carouselID={0} duration={4000} showPageArrows={false} bgColor="" imageOptions={{
    rounded : true,
    translateUp: true,
...
<Carousel images={[img1, img3, img4, img6]} carouselID={1} duration={4000} showPageArrows={false} bgColor="" imageOptions={{
    rounded : true,
    translateUp: true,
    alignment : "object-cover",
  }} client:load />

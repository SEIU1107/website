...
<Carousel images={[img1, img2, img3, img4, img5]} carouselID={0} duration={4000} showPageArrows={false}  imageOptions={{
    rounded : true,
    translateUp: true,
  }} client:load />
...
<Carousel images={[img6, img7, img8, img9]} carouselID={1} duration={4000} showPageArrows={false} imageOptions={{
    rounded : true,
    translateUp: true,
  }} client:load />
